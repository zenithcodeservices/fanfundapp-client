...
function SecondaryButton({ text, link }) {
  ...
  return (
    <button 
      ...
      className="px-4 py-2 text-base sm:text-lg font-primary font-medium text-palette-primary bg-palette-lighter rounded-md border border-palette-primary hover:bg-palette-light
